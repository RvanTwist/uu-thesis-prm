 ...
 */
public class MutationMoveSegmentGroup implements Mutation
{
	Random random;
	...
	public MutationMoveSegmentGroup(M4_Planning p, M4_MatchingAlgorithm alg)
	{
...
//DEBUG*/ prm.testSGConsistancy();
	...
	{
		return "Mutation Move SegmentGroup\n"+
				"SG: "+this.segmentGroup;
	}
}
