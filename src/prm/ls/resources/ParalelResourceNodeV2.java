 ...
 */
public class ParalelResourceNodeV2<A> implements Comparable<ParalelResourceNodeV2<A>>
{
	...
	public ParalelResourceNodeV2(int id, int capChange, A represents)
	{
		time = 0;
	...
	public ParalelResourceNodeV2(int id, int capChange)
	{
		this(id, capChange, null);
	}
	
	public ParalelResourceNodeV2(int capChange)
	{
		this(id_dispenser++, capChange,null);
	}
	
	public ParalelResourceNodeV2(int capChange, A represents)
	{
		this(id_dispenser++, capChange, represents);
	}

	@Override
	public int compareTo(ParalelResourceNodeV2 other) 
	{
